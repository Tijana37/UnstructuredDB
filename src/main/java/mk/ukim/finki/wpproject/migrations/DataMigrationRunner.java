package mk.ukim.finki.wpproject.utility;
...
//        departmentService.migrateData();
     ...
     //   personDepartmentService.migrateData();
        ...
        //* Already implemented CreditService and RatingService
        /*

        TODO: (1) Department -> (2) Person -> (3) Movies (with auto-generating relations) -> (4) Rating (implemented already) -> (5) Credits (implemented already)
         */
    }
}